...
MINDS_GOOGLE_OAUTH_CLIENT_SECRET: Final[str] = ""  # Scrubbed for this public inspiration snapshot. This is a non-confidential installed-app OAuth client secret that ships in upstream mngr; restore it from upstream if you use the Minds-provided Google OAuth client. (Unused by the pr-review app.)
